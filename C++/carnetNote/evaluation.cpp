 ...
 */
void Evaluation::setDate ( string new_var )   {
	date = new_var;
}
...
void Evaluation::affiche()
{
  ...
  cout<<"Numéro d'évaluation: "<<numero<<endl;
  laMatiere->affiche();
  cout<<"Date: "<<date<<endl;
  ...
  cout<<"La moyenne de cette évaluation est de: "<<sommeDesNotes/vectNotes.size()<<endl;
}
